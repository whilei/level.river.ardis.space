...
const config = {
  ...
  site_name: 'Columbia River Water Level History Viewer',

  // Your website's description, used for favicon meta tags
  site_description: 'Visually describing the historical water levels of the Columbia River/Roosevelt Lake',

  // Your website's URL, used for sitemap
  site_url: 'https://riverlevel.ardis.space',
